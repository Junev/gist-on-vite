...
function CreateDiagram(PaletteDiv, DiagramDiv, ChangedSelection) {
            ...
            "ChangedSelection":
                function (e) {
                    if (e.diagram.selection.size === 1) {
                        ...
                        if (part.category == "WNode" || part.category == "TNode") {
    ...
    myDiagram.nodeTemplateMap.add("WNode",  // the default category
      $(go.Node, "Table", nodeStyle(),
        // the main object is a Panel that surrounds a TextBlock with a rectangular Shape
        $(go.Panel, "Auto",
          $(go.Shape, "Rectangle",
            { fill: "#2222FF", strokeWidth: 0 },
            new go.Binding("figure", "figure")),
          $(go.TextBlock, textStyle(),
            {
                margin: 8,
    ...
    myDiagram.nodeTemplateMap.add("TNode",  // the default category
      $(go.Node, "Table", nodeStyle(),
        // the main object is a Panel that surrounds a TextBlock with a rectangular Shape
        $(go.Panel, "Auto",
          $(go.Shape, "Rectangle",
            { fill: "#FF5555", strokeWidth: 0 },
            new go.Binding("figure", "figure")),
          $(go.TextBlock, textStyle(),
            {
                margin: 8,
      ...
      $(go.Palette, PaletteDiv,  // must name or refer to the DIV HTML element
        {
            ...
            model: new go.GraphLinksModel([  // specify the contents of the Palette
              { category: "WNode", text: "分项节点" },
              { category: "TNode", text: "信息节点" },
